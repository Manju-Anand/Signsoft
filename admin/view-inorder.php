                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="brandname" name="brandname" value="<?php echo $roworders['projectname'] ?>" placeholder="Brand Name" readonly>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" name="addr" id="addr" palceholder="Here Address" rows="4" readonly><?php echo $roworders['projectdescription'] ?></textarea>
                                                            </div>
                                                        </div>
