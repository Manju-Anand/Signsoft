...
function showemployeelist()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        echo "<td>$post_deptname</td>";
        echo "<td>$post_designame</td>";
        echo "<td>$post_dis</td>";
        echo "<td>$post_created</td>";
        echo "<td>$post_modified </td>";
        echo "<td><a class='btn btn-sm btn-primary' href='edit-employee.php?edit={$id}' title='Edit' style='color:white'>
        <span class='fe fe-edit'> </span></a>&nbsp;&nbsp;
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='employeelist.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deleteemployeelist()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM employee_user WHERE empid = '" . $the_cat_id . "'";
        $delete_query = mysqli_query($connection, $query);
        if (!$delete_query) {
            die('QUERY FAILED' . mysqli_error($connection));
        }
        $query = "DELETE FROM employee WHERE id = '" . $the_cat_id . "'";
        $delete_query = mysqli_query($connection, $query);
        if (!$delete_query) {
            die('QUERY FAILED' . mysqli_error($connection));
        }
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Employee List</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-success" href="add-employee.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Add New Employee</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of Employees</h6>
