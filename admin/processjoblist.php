...
function showcategory()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        $post_jobid = $row['jobid'];
        $post_jobname ="";

        $queryjob = "select * from process_jobs where id ='" . $post_jobid . "'";
        $select_postsjob = mysqli_query($connection, $queryjob);
        while ($rowjob = mysqli_fetch_assoc($select_postsjob)) {
            $post_jobname =$rowjob['jobname'];
        }

        $post_adate = $row['assigndate'];
        $post_dis = $row['status'];
        ...
        echo "<td>$post_adate</td>";
        echo "<td>$post_dis</td>";
        echo "<td>$post_created</td>";
        echo "<td>$post_modified </td>";
        echo "<td>
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='processjoblist.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deletecategory()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM staff_pjob_allocation WHERE id = '" . $the_cat_id . "'";
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Process Job Allocation List</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-success" href="staffallocate-processjob.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Allocate New Process Jobs</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of allocated works</h6>
