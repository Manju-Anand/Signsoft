            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Combo Category</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add Combo Category</div>
                                </div>
                                <form id="addcateg" method="post" action="">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <select class="form-control select2"  multiple="multiple" name="subcategory[]" id="subcategory[]" required>
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                    ?>
                                                            <option value="<?php echo $row['id'] ?>" selected><?php echo $row['subcategory'] ?></option>
                                                    <?php } ?>
                                             </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" style="color:white;cursor:pointer;">Add Combo Category</button>
