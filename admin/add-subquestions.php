            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Subquestions</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add New Subquestions</div>
                                </div>
                                <form id="adddesig" method="post" action="">
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="desig">Sub Question:</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="desig" id="desig" placeholder="questions Name">
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="dept" class="col-md-3 form-label">Questions </label>
                                            <div class="col-md-9">
                                                <select class="form-select mb-3" aria-label="Default select example" name="dept" id="dept" required>
                                                    ...
                                                    while ($row1 = mysqli_fetch_assoc($select_edits)) {
                                                        $post_deptid = $row1['question'];

                                                    ?>
                                                        <option value="<?php echo $row1['id'] ?>"><?php echo $row1['question']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" style="color:white;cursor:pointer;">Add questions</button>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        $subquestions = $_POST["desig"];
                                        $question = $_POST["dept"];
                                        $status = $_POST["status"];
                                        date_default_timezone_set("Asia/Calcutta");
                                        $postdate = date("M d,Y h:i:s a");

                                        $sql = "INSERT INTO sub_questions (subquestion,questionid,status,created,modified) values('" . mysqli_real_escape_string($connection, $subquestions) . "',
                                        '" . mysqli_real_escape_string($connection, $question) . "','" . mysqli_real_escape_string($connection, $status) . "',
    ...
    <script>
        $(document).ready(function(e) {
            $('#cancel').delegate('', 'click change', function() {
                window.location = "subquestions.php";
                return false;
            });
        });
    </script>
