            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Edit Designation</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form id="editdesig" method="post" action="">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="desig">Designation Name :</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="desig" name="desig" value="<?php if(isset($row1['designation'])){echo $row1['designation'];} ?>" placeholder="designation Name">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
...
// echo $department;
// echo $status;
                                        $sql = "update designation set designation='". mysqli_real_escape_string($connection,$designation)."',department_id='". mysqli_real_escape_string($connection,$department)."',
