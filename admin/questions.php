...
function showquestions()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        $post_question_type = $row['question_type'];
        ...
        echo "<td>$post_question_type</td>";
        echo "<td>$post_dis</td>";
        echo "<td>$post_created</td>";
        echo "<td>$post_modified </td>";
        echo "<td><a class='btn btn-sm btn-primary' href='edit-questions.php?edit={$id}' title='Edit' style='color:white'>
        <span class='fe fe-edit'> </span></a>&nbsp;&nbsp;
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='questions.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deletequestions()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM questions WHERE id = '" . $the_cat_id . "'";
