                                        ...
                                        <div class="panel-body ">
                                            <form method="post">
                                                ...
                                                if (isset($_POST['submit'])) {
                                                    ...
                                                    $editid = $_POST["editid"];
                                                    if ($editstatus == "New") {
                                                        $sql = "INSERT INTO gd_work_approval (workid,total_hours_worked,no_internal_edits,no_external_edits,percentage_completion,created,modified,deadline_status,empid) 
                                                        ...
                                                        ,'" . mysqli_real_escape_string($connection, $postdate) . "',
                                                        '" . mysqli_real_escape_string($connection, $deadline_status) . "','" . mysqli_real_escape_string($connection, $empid) . "')";
