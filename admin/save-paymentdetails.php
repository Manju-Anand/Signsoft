<?php
// Example connectionection parameters; replace with your actual database credentials
...
foreach ($data as $row) {
    ...
    // Perform the SQL query to insert data into the first table (staff_allocation)
    ...
    if (isset($row['PaymentType'])) {
        ...
        // Perform the SQL query to insert data into the second table (payment_data)
        $sqlPayment = "INSERT INTO payment_customer (orderid, payment_type, transaction_mode, customer_billno, created,modified)
