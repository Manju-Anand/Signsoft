...
function showSupplierslist()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        $id = $row['id'];
        $post_title = $row['supplier_name'];
        $post_status = $row['status'];
        $post_created = $row['created'];
        $post_modified = $row['modified'];
        $post_gstno = $row['supplier_gstno'];
        $post_phoneno = $row['supplier_phoneno'];
        ...
        echo "<td>$post_phoneno</td>";
        echo "<td>$post_gstno</td>";
        echo "<td>$post_status</td>";
        echo "<td>$post_created</td>";
        echo "<td>$post_modified </td>";
        echo "<td><a class='btn btn-sm btn-primary' href='edit-supplier.php?edit={$id}' title='Edit' style='color:white'>
        <span class='fe fe-edit'> </span></a>&nbsp;&nbsp;
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='supplierslist.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deleteSupplierslist()
{
    global $connection;
    if (isset($_GET['delete'])) {
        $the_cat_id = $_GET['delete'];
       
        $query = "DELETE FROM suppliers WHERE id = '" . $the_cat_id . "'";
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Suppliers List</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-success" href="add-supplier.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Add New Supplier</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of Suppliers</h6>
