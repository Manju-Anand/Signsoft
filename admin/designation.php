...
function showdesignations()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        echo "<td><a class='btn btn-sm btn-primary' href='edit-designation.php?edit={$id}' title='Edit' style='color:white'>
        <span class='fe fe-edit'> </span></a>&nbsp;&nbsp;
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='designation.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deletedesignations()
{
    global $connection;
    if (isset($_GET['delete'])) {
        $the_cat_id = $_GET['delete'];
        $query = "DELETE FROM designation WHERE id = '" . $the_cat_id . "'";
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Designations</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-success" href="add-designation.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Add New Designation</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of Designations</h6>
