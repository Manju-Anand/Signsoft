...
{
    global $connection;
    $query = "select * from combocategory order by id desc";
    $select_posts = mysqli_query($connection, $query);
    $i = 0;
    while ($row = mysqli_fetch_assoc($select_posts)) {
        $id = $row['id'];
        $post_title = $row['category_id'];
        $post_title1 = $row['subcategory_id'];
        $querycat = "select * from category where id= '" . $post_title . "'";
        $select_postscat = mysqli_query($connection, $querycat);
        while ($rowcat = mysqli_fetch_assoc($select_postscat)) {
              $post_catname = $rowcat['category'];

        }
        $querysubcat = "select * from subcategory where id= '" . $post_title1 . "'";
        $select_postssubcat = mysqli_query($connection, $querysubcat);
        while ($rowsubcat = mysqli_fetch_assoc($select_postssubcat)) {
              $post_subcatname = $rowsubcat['subcategory'];
        ...
        echo "<tr>";
        echo "<td>$i</td>";
        echo "<td>$post_catname</td>";
        echo "<td>$post_subcatname</td>";
        echo "<td>$post_created</td>";
        echo "<td>$post_modified </td>";
        echo "<td><a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='combocategorylist.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deletecategory()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM combocategory WHERE id = '" . $the_cat_id . "'";
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5"> Combo Category List</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-primary" href="add-combo-category.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Add New Combo Category</a>
                            <a class="btn ripple btn-success" href="edit-combo-category.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Edit Combo Category</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of Combo Categories</h6>
