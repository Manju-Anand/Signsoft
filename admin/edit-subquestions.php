                            ...
                            <div class="card">
                                ...
                                <form id="editdesig" method="post" action="">
                                                    <?php 
                                                        ...
                                                        $post_deptname="";
                                                        $post_deptid="";
                                                        $query = "select * from sub_questions WHERE id = {$the_cat_id}";
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="desig">Sub questions Name :</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="desig" name="desig" value="<?php if(isset($row1['subquestion'])){echo $row1['subquestion'];} ?>" placeholder="questions">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <?php
                                                    $query = "select * from questions where id = '"  . $row1['questionid']  . "'";
                                                    $select_edits = mysqli_query($connection, $query);
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <select name="status" id="status" class="form-control " data-bs-placeholder="Select Status">
...
// echo $department;
// echo $status;
                                        $sql = "update sub_questions set subquestion='". mysqli_real_escape_string($connection,$subquestions)."',questionid='". mysqli_real_escape_string($connection,$question)."',
