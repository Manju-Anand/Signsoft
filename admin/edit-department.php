            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Edit Department</h2>
                            <ol class="breadcrumb">
                            ...
                            <div class="card">
                                ...
                                <form id="editdept" method="post" action="">
                                                    <?php 
                                                        ...
                                                        $query = "select * from department WHERE id = {$the_cat_id}";
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="dept">Department Name :</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="dept" name="dept" value="<?php if(isset($row1['department'])){echo $row1['department'];} ?>" placeholder="Department Name">
                                            </div>
                                        </div>
                                        <!-- ======================================== -->
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="dept">Module Name :</label>
                                            <div class="col-md-9">
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control custom-radio custom-control-md">
                                                        <input type="radio" class="custom-control-input"
                                                            name="example-radios1" <?php if($row1['dname'] == 'Sales'){ ?> checked="" <?php } ?> value="Sales" >
                                                        <span class="custom-control-label custom-control-label-md">Sales
                                                            </span>
                                                    </label>
                                                ...
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control custom-radio custom-control-md">
                                                        <input type="radio" class="custom-control-input"
                                                            name="example-radios1" <?php if($row1['dname'] == 'Web'){ ?> checked="" <?php } ?> value="Web" >
                                                        <span class="custom-control-label custom-control-label-md">Web
                                                            </span>
                                                    </label>
                                                ...
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control custom-radio custom-control-md">
                                                        <input type="radio" class="custom-control-input"
                                                            name="example-radios1" <?php if($row1['dname'] == 'Graphics'){ ?> checked="" <?php } ?> value="Graphics">
                                                        <span class="custom-control-label custom-control-label-md">Graphics
                                                            </span>
                                                    </label>
                                                ...
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control custom-radio custom-control-md">
                                                        <input type="radio" class="custom-control-input"
                                                            name="example-radios1" <?php if($row1['dname'] == 'Digital'){ ?> checked="" <?php } ?> value="Digital">
                                                        <span class="custom-control-label custom-control-label-md">Digital
                                                            </span>
                                                    </label>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $selectedValue = $_POST['example-radios1'];
// echo $department;
// echo $status;
                                        $sql = "update department set department='". mysqli_real_escape_string($connection,$department)."',
                                        status='". mysqli_real_escape_string($connection,$status)."',modified='" . mysqli_real_escape_string($connection,$postdate)."'
                                        ,dname='" . mysqli_real_escape_string($connection,$selectedValue)."'  WHERE id = {$the_cat_id}";
