            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add questions</h2>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Employee Masters</a></li>
                                <li class="breadcrumb-item active" aria-current="page">questionss</li>
                            </ol>
                        </div>
                        <div class="btn-list">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add New questions</div>
                                </div>
                                <form id="adddesig" method="post" action="">
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="desig">Question:</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row mb-4">
                                            <label for="dept" class="col-md-3 form-label">Question Type</label>
                                            <div class="col-md-9">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql = "INSERT INTO questions (question,question_type,status,created,modified) values('" . mysqli_real_escape_string($connection, $questions) . "',
                                        '" . mysqli_real_escape_string($connection, $qtype) . "','" . mysqli_real_escape_string($connection, $status) . "',
