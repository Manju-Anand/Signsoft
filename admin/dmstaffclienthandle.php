...
{
    global $connection;
    $query = "select * from department where dname = 'Digital'";
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        while($row1 = $result->fetch_assoc()) {
            $post_gdstaffname= $row1['empname'];
            $sql1 = "SELECT * FROM staff_dm_allocation where staffid='" . $row1['id'] . "' and work_status='Active'";
            $result1 = $connection->query($sql1);
            if ($result1->num_rows > 0) {
            while($row2 = $result1->fetch_assoc()) {

                $post_orderid = $row2['orderid'];
                $post_assigndate = $row2['assigndate'];
                $sql2 = "SELECT * FROM order_customers where id='" . $post_orderid . "'";
                $result2 = $connection->query($sql2);
                if ($result2->num_rows > 0) {
                while($row3 = $result2->fetch_assoc()) {
                    $post_brandName= $row3['brandName'];
                    $post_custName= $row3['custName'];
                }}
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">DM Staff Vs Clients</h2>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Admin</a></li>
                                <li class="breadcrumb-item active" aria-current="page">DM Clients</li>
                            </ol>
                        </div>
                        <div class="btn-list">
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of clients handled by each DM </h6>
