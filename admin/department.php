...
function showdepartments()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        echo "<td><a class='btn btn-sm btn-primary' href='edit-department.php?edit={$id}' title='Edit' style='color:white'>
        <span class='fe fe-edit'> </span></a>&nbsp;&nbsp;
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='department.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
        ...
        //             <span class='fe fe-edit'> </span></a> </button>&nbsp;&nbsp;
        //         <button id='bCanc' type='button' class='btn  btn-sm btn-danger'><a class='btn btn-sm btn-primary' onclick='javascript:confirmationDelete($(this));return false;' href='department.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
        //         <span class='fe fe-trash-2'> </span></a>
        //         </button>
        //         </td>";
...
function deletedepartment()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM department WHERE id = '" . $the_cat_id . "'";
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-success" href="add-department.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Add New Department</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of Departments</h6>
