...
function showsubcategory()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        $id = $row['id'];
        $post_title = $row['subcategory'];
        $post_dis = $row['status'];
        $post_created = $row['created'];
        $post_modified = $row['modified'];
        $post_catid = $row['category_id'];
        $post_catname="";
        ...
        echo "<td><a class='btn btn-sm btn-primary' href='edit-subcategory.php?edit={$id}' title='Edit' style='color:white'>
        <span class='fe fe-edit'> </span></a>&nbsp;&nbsp;
        <a class='btn btn-sm btn-danger' onclick='javascript:confirmationDelete($(this));return false;' href='subcategory.php?delete={$id}' class='text-inverse' id='qusdelete' title='Delete' data-toggle='tooltip' style='color:white'>
...
function deletesubcategory()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM subcategory WHERE id = '" . $the_cat_id . "'";
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        ...
                        <div class="btn-list">
                            ...
                            <a class="btn ripple btn-success" href="add-subcategory.php"><i class="fe fe-external-link"></i> &nbsp;&nbsp; Add New Sub-Category</a>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <div class="card-header border-bottom-0 p-0">
                                        <h6 class="card-title mb-1">List of SubCategories</h6>
