            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Edit ProcessJobs</h2>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Employee Masters</a></li>
                                <li class="breadcrumb-item active" aria-current="page">ProcessJobs</li>
                            </ol>
                        </div>
                        <div class="btn-list">
                            ...
                            <div class="card">
                                ...
                                <form id="editdept" method="post" action="">
                                                    <?php 
                                                        ...
                                                        $query = "select * from process_jobs WHERE id = {$the_cat_id}";
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="category">Process Job Name :</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="category" name="category" value="<?php if(isset($row1['jobname'])){echo $row1['jobname'];} ?>" placeholder="Job Name">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" style="color:white;cursor:pointer;">Edit Process Jobs</button>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql = "update process_jobs set jobname='". mysqli_real_escape_string($connection,$category)."',
