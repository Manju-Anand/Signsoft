            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Process Jobs</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add New Process Jobs</div>
                                </div>
                                <form id="addcateg" method="post" action="">
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="category">Process Jobs Name :</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="category" id="category" placeholder="Process Job Name">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" style="color:white;cursor:pointer;">Add Process Job</button>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql = "INSERT INTO process_jobs (jobname,status,created,modified) values('" . mysqli_real_escape_string($connection, $category) . "',
