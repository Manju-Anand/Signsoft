            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Subcategory</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form id="adddesig" method="post" action="">
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <label class="col-md-3 form-label" for="subcategory">Subcategory Name :</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="subcategory" id="subcategory" placeholder="Subcategory Name">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" style="color:white;cursor:pointer;">Add Subcategory</button>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql = "INSERT INTO subcategory (category_id,subcategory,status,created,modified) values('" . mysqli_real_escape_string($connection, $categ) . "',
                                        '" . mysqli_real_escape_string($connection, $subcategory) . "','" . mysqli_real_escape_string($connection, $status) . "',
