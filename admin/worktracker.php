...
function showtracker()
{
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        $id = $row['id'];
        $post_title = $row['emp_id'];
   
        $post_ename="";
        $queryemp = "select * from employee where id='" . $post_title . "'";
        $select_postsemp = mysqli_query($connection, $queryemp);
        while ($rowemp = mysqli_fetch_assoc($select_postsemp)) {
            $post_ename = $rowemp['empname'];
        }
        $post_noofqus = $row['no_of_qus'];
        $post_dis = $row['status'];
        ...
        echo "<tr>";
        echo "<td>$i</td>";
        echo "<td>$post_ename</td>";
        echo "<td>$post_noofqus</td>";
        echo "<td>$post_dis</td>";
...
function deletetracker()
{
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "DELETE FROM trackerdetails WHERE tracker_id  = '" . $the_cat_id . "'";
        $delete_query = mysqli_query($connection, $query);
        if (!$delete_query) {
            die('QUERY FAILED' . mysqli_error($connection));
        }

        $query = "DELETE FROM tracker WHERE id = '" . $the_cat_id . "'";
        $delete_query = mysqli_query($connection, $query);
        if (!$delete_query) {
            die('QUERY FAILED' . mysqli_error($connection));
        }
