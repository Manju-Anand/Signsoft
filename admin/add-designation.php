            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Designation</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add New Designation</div>
                                </div>
                                <form id="adddesig" method="post" action="">
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="desig" id="desig" placeholder="Designation Name">
                                            </div>
                                        </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $sql = "INSERT INTO designation (department_id,designation,status,created,modified) values('" . mysqli_real_escape_string($connection, $department) . "',
                                        '" . mysqli_real_escape_string($connection, $designation) . "','" . mysqli_real_escape_string($connection, $status) . "',
