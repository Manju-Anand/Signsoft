    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(month) {
                ...
                $.ajax({
                    type: "POST",
                    url: "fetch_data_daily_edit1.php",
                    data: {
                        month: month,
            ...
            function createTable(data) {
                ...
                headerRow += "<th>Sub Question</th>";
                headerRow += "<th>Description /  Count</th>";
                headerRow += "<th>Time Taken</th>";
                headerRow += "</tr>";
                ...
                for (var i = 0; i < data.questions.length; i++) {
                    ...
                    var rowData = "<tr><td >" + k + "</td><td>" + data.questions[i].question + "</td>";
                        ...
                        rowData += "<td class='hidden-cell'>" + data.questions[i].subqusid + "</td>";
                        rowData += "<td>" + data.questions[i].subquestion + "</td>";
                           if (data.questions[i].qtype === 'Count'){
                        rowData += "<td class='numeric-editable' >" + data.questions[i].ans + "</td>";
                    }else{
                        rowData += "<td >" + data.questions[i].ans + "</td>";
                    }
                    rowData += "<td >" + data.questions[i].timetaken + "</td>";
                        rowData += "</tr>";
...
<script src="../assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
    ...
    <script src="update_data1.js"></script>
    <script>
        $(document).ready(function() {
