...
if (isset($_POST['view'])) {
    if ($_SESSION['modulename'] == "Digital") {
        ...
        $output .= '<div
            ...
            <a class="btn ripple btn-primary btn-sm ms-auto" href="worklist.php">Latest Works Assigned</a>
        </div>';
        ...
        $output .= '<div class="dropdown-footer">
        <a class="btn ripple btn-success btn-sm btn-block" href="worklist.php">View All Notifications</a>
    </div>';
