...
$result = mysqli_query($connection, $query);
while ($row = mysqli_fetch_assoc($result)) {
    $options .= '<div class="row"><div class="col-md-3">
...
</div><div class="col-md-3"><label class="form-label" ><strong>Poster Content : </strong>' . $content  . '</label></div><div class="col-md-3">
