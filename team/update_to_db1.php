...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // }
      ...
      foreach ($postData as $data) {
          ...
          $subid = $connection->real_escape_string($data['subid']);
          $subquestion = $connection->real_escape_string($data['subquestion']);
          $timetaken = $connection->real_escape_string($data['timetaken']);
        ...
        $sql = "UPDATE dailyworkentry SET qus_ans='$qans',subqusid='$subid',timetaken='$timetaken' WHERE id='$workid'";
