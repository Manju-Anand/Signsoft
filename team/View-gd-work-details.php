                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="row" style="padding-bottom: 25px;">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <?php
                                                            $redirectstaff = "";
                                                            $sqlemp = "SELECT * FROM employee where id='" . $row1['redirect_staffid']  . "' and hod='No'";
                                                            ...
                                                            <input class='form-control' type='text' id='redirectstaff' name='redirectstaff' value='<?php echo $redirectstaff ?>' readonly>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="form-label" for="redirectdeadline">Redirected Deadline :</label>
                                                            <input class="form-control" type="text" id="redirectdeadline" name="redirectdeadline" value=" <?php echo $row1['redirect_deadline'] ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- =============================================== -->
                                                <div class="col-md-5">
                                                    ...
                                                    if (isset($_GET['workid'])) {
                                                        ...
                                                        $querynew = "select * from staff_dm_graphics_images WHERE allocation_id = {$the_cat_id}";
                                        ...
                                        <!-- </div> -->
                                        <div class="col-md-12">
                                            <a href="gdworklist.php" class="btn btn-primary float-end" style="width:200px" id="cancel">Discard</a>
                                        </div>
                                    </div>
