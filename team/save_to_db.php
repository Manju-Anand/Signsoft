...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($con->query($sqlstatus) !== TRUE) {
      ...
      foreach ($postData as $data) {
          ...
          if ($qans !== "" && $qans !== "0") {
          $sql = "INSERT INTO dailyworkentry (qus_id, emp_id ,qus_ans, work_date, created,dailyworkstatus_id,month_of_entry,year_of_entry) VALUES 
          ('$qid','$empid', '$qans', '$workdate', '$postdate' , '$last_id','$workmonth','$workyear')";
